...
app.post('/people', (req, res) => {
    ...
    /*
    My explanation for using this for loop: 
        - It wasn't specified if ID should be manually entered
        in many enviroments, the ID is supposed to be chosen rather than
        automatically decided. 
        - The IDs could be in the 10 digit range rather than sequential
        - Its best to sacrafice efficiency for security. so I chose to check
        all of the player IDs every post
    */
